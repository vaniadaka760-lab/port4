      ...
      <div className="container-gr">
        <div className="flex flex-col lg:flex-row justify-between items-center lg:items-start text-center lg:text-left gap-24 mb-32">
          <div className="max-w-md flex flex-col items-center lg:items-start">
            ...
            <p className="text-xl text-brand-muted font-display italic leading-relaxed text-center lg:text-left">
              Director of Talent Acquisition and global recruiting leader focused on building inclusive, high-performing teams for Fortune 500 organizations.
            </p>
          </div>
          ...
          <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-16 w-full text-center lg:text-left">
            <div className="space-y-8 flex flex-col items-center lg:items-start">
              ...
              <ul className="space-y-4">
                {[
                  ...
                  { name: "Endorsements", href: "#recommendations" },
            ...
            <div className="space-y-8 flex flex-col items-center lg:items-start">
              ...
              <ul className="space-y-4">
                <li><a href="mailto:hello@jeanlanctot.com" className="text-sm font-bold font-sans tracking-widest uppercase hover:text-brand-accent transition-colors">Email</a></li>
                <li><a href="https://www.linkedin.com/in/jeanlanctot/" target="_blank" rel="noopener noreferrer" className="text-sm font-bold font-sans tracking-widest uppercase hover:text-brand-accent transition-colors">LinkedIn</a></li>
              </ul>
            </div>
            <div className="space-y-8 flex flex-col items-center lg:items-start">
              <div className="section-label justify-center lg:justify-start mb-8">CONTACT</div>
              <div className="space-y-2">
                 <div className="text-[11px] font-mono font-bold uppercase text-brand-muted tracking-widest">Location</div>
                 {/* TODO: confirm Jean's current city/region */}
              ...
              <div className="space-y-2 pt-4">
                 ...
                 <div className="text-sm font-bold font-sans tracking-widest uppercase">Select Consultations</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="pt-12 border-t border-brand-primary/10 flex flex-col md:flex-row justify-between items-center gap-10">
          <p className="font-mono text-[11px] font-bold tracking-[0.3em] uppercase text-brand-muted">
            © 2026 JEAN LANCTOT. ALL RIGHTS RESERVED.
          </p>
          <div className="flex gap-10">
             <a href="https://www.linkedin.com/in/jeanlanctot/" target="_blank" rel="noopener noreferrer" className="text-brand-muted hover:text-brand-accent transition-colors"><Linkedin size={18} /></a>
             <a href="mailto:hello@jeanlanctot.com" className="text-brand-muted hover:text-brand-accent transition-colors"><Mail size={18} /></a>
          </div>
        </div>
      </div>
    </footer>
